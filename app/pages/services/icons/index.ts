...
import miroIcon from "./miro.png";
import mondayIcon from "./monday.png";
...
import trelloIcon from "./trello.png";
...
export const airtable = [airtableIcon, "Airtable"] as const;
export const alacritty = [alacrittyIcon, "Alacritty"] as const;
export const asana = [asanaIcon, "Asana"] as const;
export const astro = [astroIcon, "Astro"] as const;
export const atlassian = [atlassianIcon, "Atlassian"] as const;
...
export const clickup = [clickupIcon, "ClickUp"] as const;
export const confluence = [confluenceIcon, "Confluence"] as const;
...
export const jira = [jiraIcon, "Jira"] as const;
export const js = [jsIcon, "JavaScript"] as const;
export const meet = [meetIcon, "Meet"] as const;
export const miro = [miroIcon, "Miro"] as const;
export const monday = [mondayIcon, "Monday"] as const;
...
export const notion = [notionIcon, "Notion"] as const;
...
export const wrike = [wrikeIcon, "Wrike"] as const;
export const zapier = [zapierIcon, "Zapier"] as const;
export const zoom = [zoomIcon, "Zoom"] as const;
